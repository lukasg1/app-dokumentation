...
\usepackage{xcolor}   % Paket für Farbdefinitionen

\lstdefinestyle{mystyle}{
    basicstyle=\ttfamily\small,     % Schriftart und -größe des Codes
    breakatwhitespace=false,        % Zeilenumbrüche nur bei Leerzeichen
